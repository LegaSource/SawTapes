...
public class Constants
{
    ...
    public const string MESSAGE_INFO_FIND_KEY_EXPLOSIVE = "You may end the game by interacting with the container again… but hesitate too long, and that choice will vanish. Find the key, or accept the outcome";
    public const string MESSAGE_INFO_IMP_END_EXPLOSIVE = "Your chance is gone. Now the key is your only path to salvation";
    // Configs
