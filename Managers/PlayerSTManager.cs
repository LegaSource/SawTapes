...
{
    public static Dictionary<PlayerControllerB, PlayerSTBehaviour> playerBehavioursCache = [];
    ...
    public static PlayerSTBehaviour GetPlayerBehaviour(PlayerControllerB player)
    {
        ...
        if (playerBehaviour == null)
        {
            ...
            return playerBehavioursCache.TryGetValue(player, out playerBehaviour) ? playerBehaviour : playerBehaviour;
        }
